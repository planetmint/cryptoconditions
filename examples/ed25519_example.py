...
result = (
    fulfillment.validate(message=message.encode())
    and condition_uri == fulfillment.condition_uri
)
print(result)
...
sk_b58 = base58.b58encode(
    binascii.unhexlify(
        "1a3ab1a87f000348f391613930cc49529652ecf2d2c7cadfd96e87a7f6de948a"
    )
)
sk = SigningKey(sk_b58)
