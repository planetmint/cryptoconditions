...
class TestFulfillment:
    ...
    def test_serialize_binary_raises_with_non_initialize_simple_types(
        ...
        err_msg = (
            ...
            "into pyasn1 schema object."
        ).format({fulfillment.TYPE_ASN1: fulfillment.asn1_dict_payload})
...
class TestPreimageSha256:
    ...
    def test_fulfillment_serialize_to_dict(self, fulfillment_sha256):
        ...
        assert (
            parsed_fulfillment.condition.serialize_uri()
...
class TestEd25519Sha256Fulfillment:
    ...
    def test_deserialize_signed_dict_to_fulfillment(self, fulfillment_ed25519):
        ...
        assert (
            parsed_fulfillment.serialize_uri() == fulfillment_ed25519["fulfillment_uri"]
        )
        assert (
            parsed_fulfillment.condition.serialize_uri()
            == fulfillment.condition.serialize_uri()
...
class TestThresholdSha256Fulfillment:
    ...
    def test_deserialize_signed_dict_to_fulfillment(self, fulfillment_threshold):
        ...
        assert (
            parsed_fulfillment.serialize_uri()
    ...
    def test_fulfillment_didnt_reach_threshold(self, vk_ilp, fulfillment_ed25519):
        ...
        assert (
            len(
                [
                    f
                    for f in deserialized_fulfillment.subconditions
    ...
    def test_fulfillment_nested_and_or(
        ...
        assert (
            ...
            == fulfillment_threshold_nested_and_or["condition_uri"]
        )
