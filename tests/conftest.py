...
# ED25519
VK_HEX_ILP = (
    b"ec172b93ad5e563bf4932c70e1245034c35467ef2efd4d64ebf819683467e2bf"  # noqa E501
)
...
SK_HEX_ILP = (
    b"833fe62409237b9d62ec77587520911e9a759cec1d19755b7da901b96dca3d42"  # noqa E501
)
...
SK_HEX_ILP_2 = (
    b"1a3ab1a87f000348f391613930cc49529652ecf2d2c7cadfd96e87a7f6de948a"  # noqa E501
)
SK_B58_ILP_2 = b"2mPWYbfDE2HrUaisDViseCLDcshYeRiJzR2XYkfmiK4m"

VK_HEX_ILP_2 = (
    b"a614d63a28be3e8e45ea99638d22abc0430e4112a28b3f601a617f9c7f445021"  # noqa E501
)
...
CONDITION_SHA256_HASH = (
    b"e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855"  # noqa E501
)
FULFILLMENT_SHA256_URI = "cf:0:"

CONDITION_ED25519_URI = (
    "cc:4:20:7Bcrk61eVjv0kyxw4SRQNMNUZ-8u_U1k6_gZaDRn4r8:96"  # noqa E501
)
CONDITION_ED25519_HASH = (
    b"ec172b93ad5e563bf4932c70e1245034c35467ef2efd4d64ebf819683467e2bf"  # noqa E501
)
...
CONDITION_ED25519_URI_2 = (
    "cc:4:20:phTWOii-Po5F6pljjSKrwEMOQRKiiz9gGmF_nH9EUCE:96"  # noqa E501
)
CONDITION_ED25519_HASH_2 = (
    b"a614d63a28be3e8e45ea99638d22abc0430e4112a28b3f601a617f9c7f445021"  # noqa E501
)
...
CONDITION_THRESHOLD_SHA_ED25519_URI = (
    "cc:2:2b:mJUaGKCuF5n-3tfXM2U81VYtHbX-N8MP6kz8R-ASwNQ:146"  # noqa E501
)
...
CONDITION_NESTED_AND_OR_URI = (
    "cc:2:2b:ytUyoE7fu1QzQMCDpx9xxi09ojfL_vbykvtJZsI0JEE:161"  # noqa E501
)
...
Ed25519TestVector = namedtuple(
    "Ed25519TestVector", TestVector._fields + ("private_key",)
)
...
def normalize_value(value, key):
    ...
    if key == "fulfillment":
        value = base64_remove_padding(
            urlsafe_b64encode(unhexlify(value.encode()))
        ).decode()
    return value
...
def test_vector(request):
    ...
    return TestVector(
        **{
            snake_case(k): normalize_value(v, snake_case(k))
...
def minimal_ed25519(minimal_ed25519_private_key):
    ...
    with open("tests/vectors/{}.json".format(vector_name), "r") as f:
        test_vector = json.load(f)
    vector = {
        snake_case(k): normalize_value(v, snake_case(k)) for k, v in test_vector.items()
    }
